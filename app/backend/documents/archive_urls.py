...
urlpatterns = [
    ...
    path(
        "manage/authors/",
        views.archive_manage_authors_page,
        name="archive-manage-authors",
    ),
    path(
    ...
    path(
        "manage/people/<int:person_id>/merge/",
        views.archive_manage_person_merge_page,
        name="archive-manage-person-merge",
    ),
    path(
