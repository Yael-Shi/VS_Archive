...
blocked even if the mapped Tag row is gone). D2b Tag-row deletion
remains deferred and must refuse while PENDING
`ArchiveMetadataSuggestion` rows contain those retired names.
