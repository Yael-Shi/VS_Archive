...
- `ENABLE_ANTIGRAVITY_ARABIC_PRINTED_BANDED` does **not** change this routing table. It is a worker-only **execution** flag (code default **false**) inside `AntigravityAdapter`.
